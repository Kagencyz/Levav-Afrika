...
| `rubrics/` | Behaviourally Anchored Rating Scales per WRI dimension, versioned. Anchors describe observable behaviour, never vague adjectives (WRI-005) | **`BARS_v1.md` is live** — all ten dimensions anchored |
...
`scenarios/` is empty; scenario content follows the build sequence in Master PRD §46 (Sprint 4).

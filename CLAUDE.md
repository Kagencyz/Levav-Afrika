...
- **A green typecheck is not evidence for `src/`** — 156 frontend errors at Sprint 0, being fixed in WP-0002 — **and it is not evidence for those ten server files either.**

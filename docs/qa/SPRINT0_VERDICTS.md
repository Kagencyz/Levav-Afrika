...
| **WP-0002** — Real verification gates and CI | **ACCEPTED** — one S3 recorded below |
| **WP-0003** — Remove client-side WRI scoring | **ACCEPTED** |

WP-0001 and WP-0003 were accepted at `0f11ffb` in an earlier review; that commit is unchanged and the verdict stands. WP-0002 is accepted here for the first time.

/**
 * Levav Data Store
 * Central prototype data models for Levav 28™, Learn, QuickWork™, Impact, and Feed.
...
export const FEED_POSTS: FeedPost[] = [
  ...
  },
  {
    ...
    body: 'Capable and available, not idle. Picked up a three-day API integration assignment between contracts, delivered it, and received a review.',
    tag: 'QuickWork™ win',

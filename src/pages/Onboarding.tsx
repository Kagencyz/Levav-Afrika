...
import { isValidEmail, sanitizeInput } from '@/lib/safeJSON';
...
export default function Onboarding() {
  ...
  const MAX_CUSTOM_SKILL_LENGTH = 50;
      ...
      <div className="w-full max-w-md mx-auto mb-8">
        <div className="flex items-center justify-between relative">
          ...
          {STEP_CONFIG.map((step, index) => {
            ...
            const isInactive = currentStep < step.id && !isComplete;
    ...
    return (
      ...
      >
        ...
        <div>
          ...
          <ErrorMessage field="yearsOfExperience" />
        </div>
        ...
        <div>
          ...
          <ErrorMessage field="primarySkills" />
        </div>
        ...
        <div>
          ...
          <ErrorMessage field="employmentStatus" />
        </div>
        ...
        <div>
          ...
          <ErrorMessage field="highestEducation" />
        </div>
        ...
        <div>
          ...
          />
          <ErrorMessage field="linkedinUrl" />
        </div>
    ...
    return (
      ...
      >
        ...
        <div>
          ...
          />
          <ErrorMessage field="careerChallenge" />
        </div>
